  ...
  return (
    <>
      <header
        ...
        style={{
          height: isHomePage ? 'var(--header-height)' : 'auto',
          marginBottom: isHomePage ? 'var(--header-mb)' : '0',
        }}
      >
        {isHomePage && (
          <>
        ...
        <div ref={headerRef} className="z-10">
          <div className="w-full sm:px-8">
            <div className="mx-auto w-full max-w-7xl lg:px-8">
              <div className="w-full bg-white/80 backdrop-blur-md transition-colors dark:bg-zinc-900/80">
